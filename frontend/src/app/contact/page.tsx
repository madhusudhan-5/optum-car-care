...
export default async function ContactPage() {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen text-white">
      ...
      {/* ── HERO ── */}
      <section className="relative pt-20 pb-12 px-6 md:px-12 border-b border-white/5 bg-gradient-to-b from-[#111] to-[#0a0a0a] overflow-hidden">
      ...
      {/* ── INFO + FORM ── */}
      <section id="appointment-form" className="py-12 px-6 md:px-12 scroll-mt-24">
                ...
                <div className="border-t border-white/5 pt-4 mt-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-400 font-bold uppercase tracking-wider text-xs">Mon – Sat</span>
      ...
      {services.length > 0 && (
        <section className="bg-[#111] py-10 px-6 md:px-12 border-t border-white/5">
          <div className="max-w-7xl mx-auto">
            <ScrollReveal direction="up">
